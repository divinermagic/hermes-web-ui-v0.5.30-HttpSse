...
function sseUrl(opts?: KanbanBoardOptions): string {
...
export function buildKanbanEventsSseUrl(opts?: KanbanBoardOptions): string {
  return sseUrl(opts)
}
...
export function openKanbanEventStream(opts?: KanbanBoardOptions): EventSource {
  return new EventSource(sseUrl(opts))
}
